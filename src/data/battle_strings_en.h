...
const u8 BattleText_TryingToLearnMove[] = _("{STRING 0} est en train\nd’essayer d’apprendre {STRING 1}.\p");
const u8 BattleText_CantLearnMore[] = _("Mais, {STRING 0} ne peut pas\napprendre plus de quatre attaques.\p");
const u8 BattleText_DeleteMove[] = _("Delete a move to make\nroom for {STRING 1}?");
const u8 BattleText_DeletedMove[] = _("{STRING 0} a oublié\n{STRING 1}.\p");
const u8 BattleText_StopLearning[] = _("{PAUSE 32}a arreté d’apprendre\n{STRING 1}?");
const u8 BattleText_DidNotLearn[] = _("{STRING 0} n’a pas appris\n{STRING 1}.\p");
const u8 BattleText_UseNext[] = _("Voulez-vous utilisez un\nautre Pokémon?");
const u8 BattleText_AttackMissed[] = _("{ATTACKING_MON} a raté son attaque!");
...
const u8 BattleText_GroundMoveNegate[] = _("{DEFENDING_MON} rend les attaque Sol\ninéficaces à cause de {STRING 22}!");
const u8 BattleText_AvoidedAttack[] = _("{DEFENDING_MON} avoided\nthe attack!");
const u8 BattleText_DoesntAffect[] = _("Cela n’a aucun effet\nsur {DEFENDING_MON}...");
const u8 BattleText_AttackingFainted[] = _("{ATTACKING_MON}\nest K.O.!\p");
const u8 BattleText_DefendingFainted[] = _("{DEFENDING_MON}\nest K.O.!\p");
const u8 BattleText_WinningPrize[] = _("{STRING 32} reçois ¥{STRING 0}\ngrace à la victoire!\p");
const u8 BattleText_OutOfUsablePoke[] = _("{STRING 32} n’a plus de\nPokémon utilisable!\p");
const u8 BattleText_WhitedOut[] = _("{STRING 32} est hors-jeu!{PAUSE_UNTIL_PRESS}");
const u8 BattleText_PreventEscape[] = _("{STRING 16} prevents\nescape with {STRING 23}!\p");
const u8 BattleText_CantEscape[] = _("Impossible de fuir!\p");
const u8 BattleText_AttackingCantEscape[] = _("{ATTACKING_MON}\nne peut pas fuir!");
const u8 BattleText_HitMulti[] = _("{ATTACKING_MON} a touché {STRING 0} fois!");
const u8 BattleText_FellAsleep[] = _("{STRING 14}\nc’est endormi!");
const u8 BattleText_MadeAsleep[] = _("{STRING 16}’s {STRING 23}\nmade {STRING 14} sleep!");
const u8 BattleText_DefendingAsleep[] = _("{DEFENDING_MON} est\ndéjà endormi!");
const u8 BattleText_AttackingAsleep[] = _("{ATTACKING_MON} est\ndéjà endormi!");
...
const u8 BattleText_PoisonHurt[] = _("{ATTACKING_MON} se blesse\npar le poison!");
const u8 BattleText_AlreadyPoisoned[] = _("{DEFENDING_MON} est déjà\nempoisonné.");
const u8 BattleText_BadlyPoisoned[] = _("{STRING 14} est gravement\nempoisonné!");
const u8 BattleText_EnergyDrained[] = _("{DEFENDING_MON} had its\nenergy drained!");
const u8 BattleText_Burned[] = _("{STRING 14} est brûlé!");
const u8 BattleText_Burned2[] = _("{STRING 16}’s {STRING 23}\nburned {STRING 14}!");
const u8 BattleText_BurnHurt[] = _("{ATTACKING_MON} se blesse\npar la brûlure!");
const u8 BattleText_AlreadyBurned[] = _("{DEFENDING_MON} est déjà\nbrûlé.");
const u8 BattleText_Frozen[] = _("{STRING 14} est gelé!");
const u8 BattleText_Frozen2[] = _("{STRING 16}’s {STRING 23}\nfroze {STRING 14} solid!");
const u8 BattleText_FrozenSolid[] = _("{ATTACKING_MON} est\ngelé!");
const u8 BattleText_DefendingDefrosted[] = _("{DEFENDING_MON} s’est dégelé!");
const u8 BattleText_AttackingDefrosted[] = _("{ATTACKING_MON} s’est dégelé!");
const u8 BattleText_Defrosted[] = _("{ATTACKING_MON} s’est\ndégelé grace à {STRING 17}!");
const u8 BattleText_Paralyzed[] = _("{STRING 14} est paralysé!\nIl ne peut pas attaquer!");
const u8 BattleText_Paralyzed2[] = _("{STRING 16}’s {STRING 23}\nparalyzed {STRING 14}!\lIt may be unable to move!");
const u8 BattleText_Paralyzed3[] = _("{ATTACKING_MON} est paralysé!\nIl ne peut pas attaquer!");
const u8 BattleText_AlreadyParalyzed[] = _("{DEFENDING_MON} est\ndéjà paralyser!");
const u8 BattleText_ParalysisHealed[] = _("{DEFENDING_MON} s’est\ngéris de la paralysis!");
...
const u8 BattleText_Confused[] = _("{ATTACKING_MON} est\nconfus!");
const u8 BattleText_ConfusionSnapOut[] = _("{ATTACKING_MON} n’est\nplus confus!");
const u8 BattleText_BecameConfused[] = _("{STRING 14} est\nmaintenant confus!");
const u8 BattleText_AlreadyConfused[] = _("{DEFENDING_MON} est\ndéjà confus!");
...
const u8 BattleText_TypeTransform[] = _("{ATTACKING_MON} devient\ndu type {STRING 0}!");
const u8 BattleText_Flinched[] = _("{ATTACKING_MON} à la trouille!");
const u8 BattleText_RegainedHealth[] = _("{DEFENDING_MON} regagne de\nla vie!");
const u8 BattleText_HPFull[] = _("Les PV de {DEFENDING_MON}\nest au maximum!");
...
const u8 BattleText_Transformed2[] = _("{STRING 16} se transforme!");
...
const u8 BattleText_Critical[] = _("Coup critique!");
const u8 BattleText_GrandSlam[] = _("KO en un coup!");
const u8 BattleText_MoveForget123[] = _("{PAUSE 32}1, {PAUSE 15}2 et...{PAUSE 15} ...{PAUSE 15} ...{PAUSE 15}\n{PAUSE 15}{PLAY_SE SE_KON}Poof!\p");
const u8 BattleText_MoveForgetAnd[] = _("Et...\p");
const u8 BattleText_CantForgetHM[] = _("HM moves can’t be\nforgotten now.\p");
const u8 BattleText_NotEffective[] = _("Ce n'est pas très efficace...");
const u8 BattleText_SuperEffective[] = _("C'est super efficace!");
...
const u8 BattleText_Nothing[] = _("Mais rien ne se passe!");
const u8 BattleText_Failed[] = _("Mais cela échoue!");
...
const u8 BattleText_NoPP1[] = _("Il ne reste plus de PP\npour cette attaque!\p");
...
const u8 BattleText_PlayerDefeatedTrainer2[] = _("Le joueur a battu\n{STRING 25} {STRING 26}!\p");
...
const u8 BattleText_WatchingCarefully[] = _("{STRING 3} regarde\nattentivement!");
...
const u8 BattleText_ComeBackSingle2[] = _("{STRING 0}, reviens!");
const u8 BattleText_ComeBackSingle3[] = _("{STRING 0}, OK!\nReviens!");
const u8 BattleText_ComeBackSingle4[] = _("{STRING 0}, super!\nReviens!");
const u8 BattleText_WithdrewPoke1[] = _("{STRING 25} {STRING 26}\nretire {STRING 0}!");
const u8 BattleText_WithdrewPoke2[] = _("{STRING 29} retire\n{STRING 0}!");
const u8 BattleText_WithdrewPoke3[] = _("{STRING 31} retire\n{STRING 0}!");
const u8 BattleText_Wild[] = _("Sauvage ");
const u8 BattleText_Foe[] = _("Ennemi ");
const u8 BattleText_Foe2[] = _("Ennemi ");
const u8 BattleText_Ally[] = _("Allié ");
const u8 BattleText_Foe3[] = _("Ennemi ");
const u8 BattleText_Ally2[] = _("Allié ");
const u8 BattleText_Foe4[] = _("Ennemi ");
const u8 BattleText_Ally3[] = _("Allié ");
const u8 BattleText_OpponentUsedMove[] = _("{ATTACKING_MON} utilise\n{STRING 1}");
...
const u8 BattleStatText_HP[] = _("PV");
const u8 BattleStatText_Attack[] = _("Attaque");
const u8 BattleStatText_Defense[] = _("Defense");
const u8 BattleStatText_Speed[] = _("Vitesse");
const u8 BattleStatText_SpAtk[] = _("Sp. Atq");
...
const u8 BattleText_StartEvo[] = _("Quoi?\n{STRING 2} est en train d'évoluer!");
const u8 BattleText_FinishEvo[] = _("Félicitation! Votre {STRING 2}\na évolué en {STRING 3}!{UNKNOWN_A}\p");
...
const u8 BattleText_MenuOptions[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW SKY_BLUE LIGHT_BLUE WHITE2}Combat{CLEAR_TO 0x2E}Sac\nPokémon{CLEAR_TO 0x2E}Fuite");
const u8 BattleText_MenuOptionsSafari[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW SKY_BLUE LIGHT_BLUE WHITE2}Ball{CLEAR_TO 0x2E}{POKEBLOCK}\nGO NEAR{CLEAR_TO 0x2E}Fuite");
...
const u8 BattleText_ForgetMove[] = _("{COLOR_HIGHLIGHT_SHADOW SKY_BLUE LIGHT_BLUE WHITE2}{PALETTE 5}Quelle attaque doit\nêtre oublier?");
const u8 BattleText_YesNo[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW SKY_BLUE LIGHT_BLUE WHITE2}Oui\nNon");
...
const u8 BattleText_HP[] = _("PV     ");
const u8 BattleText_Attack[] = _("Attaque");
const u8 BattleText_Defense[] = _("DEFENSE");
const u8 BattleText_SpAtk[] = _("Sp. Atq");
const u8 BattleText_SpDef[] = _("Sp. Def");
const u8 BattleText_SafariBalls[] = _("{HIGHLIGHT RED}Safari Balls");
const u8 BattleText_SafariBallsLeft[] = _("{HIGHLIGHT RED}Restant: ");
...
const u8 gBadEggNickname[] = _("Mauvais oeuf"); // 8400E3A
const u8 BattleText_Wally[] = _("WALLY");
const u8 BattleText_Win[] = _("{HIGHLIGHT TRANSPARENT}Victoire"); // 8400E48
const u8 BattleText_Loss[] = _("{HIGHLIGHT TRANSPARENT}Défaite"); // 8400E4F
const u8 BattleText_Tie[] = _("{HIGHLIGHT TRANSPARENT}Egalité"); // 8400E57
const u8 BattleText_Format10[] = _(" est");
const u8 BattleText_Format11[] = _(" est");
const u8 BattleText_Normal[] = _("une attaque Normal");
const u8 BattleText_Fighting[] = _("une attaque Combat");
const u8 BattleText_Flying[] = _("une attaque Vol");
const u8 BattleText_Poison[] = _("une attaque Poison");
const u8 BattleText_Ground[] = _("une attaque Sol");
const u8 BattleText_Rock[] = _("une attaque Roche");
const u8 BattleText_Bug[] = _("une attaque Insecte");
const u8 BattleText_Ghost[] = _("une attaque Spectre");
const u8 BattleText_Steel[] = _("une attaque Acier");
const u8 BattleText_Typeless[] = _("une attaque ???");
const u8 BattleText_Fire[] = _("une attaque Feu");
const u8 BattleText_Water[] = _("une attaque Eau");
const u8 BattleText_Grass[] = _("une attaque Plante");
const u8 BattleText_Electric[] = _("une attaque Electrique");
const u8 BattleText_Psychic[] = _("une attaque Psy");
const u8 BattleText_Ice[] = _("une attaque Glace");
const u8 BattleText_Dragon[] = _("une attaque Dragon");
const u8 BattleText_Dark[] = _("une attaque Ténébre");
